...
Step 2: Use build_best_sars.ipynb and build_best_mers.ipynb to align the poses to the respective sars or mers receptor, generating best_sars.sdf and best_mers.sdf files.
